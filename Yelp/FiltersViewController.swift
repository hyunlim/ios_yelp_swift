...
class FiltersViewController: UIViewController {
    ...
    internal weak var delegate:FiltersViewControllerDelegate?
    ...
    @IBAction func onSearch(sender: AnyObject) {
        ...
        if selectedCatagories.count > 0 {
            filters["categories"] = selectedCatagories
        }
...
extension FiltersViewController: UITableViewDataSource {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("com.lyft.SwitchCell", forIndexPath: indexPath) as! SwitchCell
        
        cell.switchLabel.text = self.categories[indexPath.row]["name"]
        cell.delegate = self
        cell.toggleSwitch.on = self.switchState[indexPath.row] ?? false
